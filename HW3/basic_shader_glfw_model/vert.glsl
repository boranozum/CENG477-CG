...
void main(void)
{
	...
	vec3 c2 = vec3(0.2, 0, 0.2);
	vec3 c3 = vec3(0, 0, 0.8);
	vec3 c4 = vec3(0, 0.4, 0);
	vec3 c5 = vec3(0.2, 0, 0);

	vec3 colors[5] = vec3[5](c1, c2, c3, c4, c5);
	...
	gl_FrontColor = vec4(colors[colorIndex] + diffuseColor + ambientColor + specularColor, 1);
